...
> the current README (K=20, `optimization_level=1`, 127-qubit FakeBrisbane / 80-qubit Rigetti).
...
- **Table 2 — Rigetti Grid (80q)**: 7 tasks (Grover N=8/10/12, VQE N=50, QFT N=20, and 2
